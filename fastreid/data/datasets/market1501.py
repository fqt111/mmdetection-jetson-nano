...
class Market1501(ImageDataset):
    ...
    def __init__(self, root='datasets', market1501_500k=False, **kwargs):
        ...
        self.query_dir = osp.join(self.data_dir, 'reid/query_test')
        self.gallery_dir = osp.join(self.data_dir, 'reid/gallery')
    ...
    def process_dir(self, dir_path, is_train=True):
        ...
        for img_path in img_paths:
            ...
            # print('camid',camid)
            # print('frame id',int(img_path[-10:-7]))

            data.append((img_path, pid, camid, int(img_path[-10:-7]),int(img_path[-6:-4])))
